...
from external.nms import soft_nms_7
...
class RearHeadLightDetector(BaseDetector):
    ...
    def merge_outputs(self, detections):
        ...
        # print("type:", type(results[1]), results[1].shape)  # 100*7(4,1,2)
        if self.opt.nms or len(self.opt.test_scales) > 1:
            soft_nms_7(results[1], Nt=0.5, method=2)
        print("type:", results[1][:, 4])  # 100*7(4,1,2)
